...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Mate', function() {
      beforeEach(function() {
        instance = new Beneficiary.Mate();
      });

      it('should create an instance of Mate', function() {
        // TODO: update the code to test Mate
        expect(instance).to.be.a(Beneficiary.Mate);
      });

      it('should have the property totalPage (base name: "totalPage")', function() {
        // TODO: update the code to test the property totalPage
        expect(instance).to.have.property('totalPage');
        // expect(instance.totalPage).to.be(expectedValueLiteral);
      });
