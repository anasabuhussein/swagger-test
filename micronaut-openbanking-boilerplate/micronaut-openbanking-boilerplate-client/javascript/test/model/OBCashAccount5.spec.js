...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OBCashAccount5', function() {
      beforeEach(function() {
        instance = new Beneficiary.OBCashAccount5();
      });

      it('should create an instance of OBCashAccount5', function() {
        // TODO: update the code to test OBCashAccount5
        expect(instance).to.be.a(Beneficiary.OBCashAccount5);
      });
      ...
      it('should have the property secondaryIdentification (base name: "secondaryIdentification")', function() {
        // TODO: update the code to test the property secondaryIdentification
        expect(instance).to.have.property('secondaryIdentification');
        // expect(instance.secondaryIdentification).to.be(expectedValueLiteral);
      });
